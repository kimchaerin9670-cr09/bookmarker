...
// JPA를 통해서 Pagenation 처리를 하면 현재 페이지, 전체 페이지, 끝여부 ... => DTO로 변경해서 처리하겠다.
@Getter
@Setter
public class BookmarksDto {
	...
	// JOSN의 결과의 값이 다름 isFirst => first (중요)
	...
	public BookmarksDto(Page<BookmarkDto> bookmarkPage) {
		...
		this.setCurrentPage(bookmarkPage.getNumber()+1); // 0과 1로 처리되어서 꼭 +1 해줘야함
